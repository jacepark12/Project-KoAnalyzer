...
public class SearchCorpusData{
    ...
    private static SearchCorpusData instance;
    ...
    public boolean isWordPositive(CharSequence word)throws IOException, NoWordDataException{
        ...
        if(!isWordDataExists){
            throw  new NoWordDataException("No word :" + word.toString() + " in corpus data");
        }
        return result;
